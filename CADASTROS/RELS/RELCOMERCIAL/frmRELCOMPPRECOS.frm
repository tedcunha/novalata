...
Begin VB.Form frmRELCOMPPRECOS 
   Caption         =   "Relatório de Estudo de Preços"
   ClientHeight    =   3000
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   12825
        ...
        If boolTemDadosNOVA = True Then
             ...
             For lngREGS = 1 To UBound(arrCLIENTESNOVALATA)
                ...
                If arrCLIENTESNOVALATA(lngREGS).lngQTDECAPACIDADE > 0 Then
                   lngCol = (lngCol + 1)
                   .WriteValue xlsText, xlsFont0, xlsLeftAlign, xlsNormal, lngLINHA, lngCol, arrCLIENTESNOVALATA(lngREGS).arrCAPACIDADE(1).strDESCLIN, 12         '' Descrição da Linha
                   ...
                   If arrCLIENTESNOVALATA(lngREGS).lngQTDECAPACIDADE > 1 Then
                      ...
                      For lngREGSCAPAC = 2 To arrCLIENTESNOVALATA(lngREGS).lngQTDECAPACIDADE
                            lngLINHA = (lngLINHA + 1)
                            .WriteValue xlsText, xlsFont0, xlsLeftAlign, xlsNormal, lngLINHA, lngCol, arrCLIENTESNOVALATA(lngREGS).arrCAPACIDADE(lngREGSCAPAC).strDESCLIN, 12         '' Descrição da Linha
                            .WriteValue xlsText, xlsFont0, xlsLeftAlign, xlsNormal, lngLINHA, ((lngCol + lngQTDANOS) + 1), "NOVALATA", 12                                             '' Empresa
        ...
        If boolTemDadosSTEEL = True Then
             ...
             For lngREGS = 1 To UBound(arrCLIENTESSTEEL)
                ...
                If arrCLIENTESSTEEL(lngREGS).lngQTDECAPACIDADE > 0 Then
                   lngCol = (lngCol + 1)
                  .WriteValue xlsText, xlsFont0, xlsLeftAlign, xlsNormal, lngLINHA, lngCol, arrCLIENTESSTEEL(lngREGS).arrCAPACIDADE(1).strDESCLIN, 12         '' DESCRIÇÃO DA LINHA
                  ...
                  If arrCLIENTESSTEEL(lngREGS).lngQTDECAPACIDADE > 1 Then
                     For lngREGSCAPAC = 2 To arrCLIENTESSTEEL(lngREGS).lngQTDECAPACIDADE
                         ...
                         .WriteValue xlsText, xlsFont0, xlsLeftAlign, xlsNormal, lngLINHA, lngCol, arrCLIENTESSTEEL(lngREGS).arrCAPACIDADE(lngREGSCAPAC).strDESCLIN, 12          '' RAZÃO SOCIAL
                         .WriteValue xlsText, xlsFont0, xlsLeftAlign, xlsNormal, lngLINHA, ((lngCol + lngQTDANOS) + 1), "STEEL", 12                                              '' Empresa
