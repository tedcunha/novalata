...
Begin VB.Form frmCADTIPAPPRODP 
   ...
   Begin VB.Frame Frame3 
      ...
      Top             =   1440
      Width           =   11535
      Begin VSFlex8LCtl.VSFlexGrid grdTIPAPONT 
         Height          =   5655
         Left            =   120
         TabIndex        =   13
         Top             =   120
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton cmdOrden 
         ...
         Height          =   615
         Left            =   10560
         Picture         =   "frmCADTIPAPPRODP.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   120
         Width           =   855
      ...
      Begin VB.CommandButton cmdCanFiltro 
         ...
         Height          =   615
         Left            =   9720
         Picture         =   "frmCADTIPAPPRODP.frx":0102
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   120
         Width           =   855
      ...
      Begin VB.CommandButton cmdExclui 
         ...
         Height          =   615
         Left            =   2640
         Picture         =   "frmCADTIPAPPRODP.frx":0634
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      Begin VB.CommandButton cmdAltera 
         ...
         Height          =   615
         Left            =   1800
         Picture         =   "frmCADTIPAPPRODP.frx":0736
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin VB.CommandButton cmdInclui 
         ...
         Height          =   615
         Left            =   960
         Picture         =   "frmCADTIPAPPRODP.frx":0838
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.CommandButton cmdVoltar 
         ...
         Height          =   615
         Left            =   120
         Picture         =   "frmCADTIPAPPRODP.frx":0D6A
         Style           =   1  'Graphical
         TabIndex        =   6
   ...
   End
End
Attribute VB_Name = "frmCADTIPAPPRODP"
...
Dim objCADTIPAPPRODP    As Object
Dim iCodigo             As Integer

Const conCOL_Mov_Codigo                          As Integer = 0
Const conCOL_Mov_Descri                          As Integer = 1
Const conCOL_Mov_Ativo                           As Integer = 2
Const conCOL_Mov_FormatString                    As String = "=Código|Descrição|Ativo"
Const conColumnsIn_Mov                           As Integer = 3
...
Private Sub cmdExclui_Click()
  ...
  If objCADTIPAPPRODP.GRAVA("E") = False Then Exit Sub
...
Private Sub Form_Load()
    ...
    Set objCADTIPAPPRODP = CreateObject("CADTIPAPPROD.clsCADTIPAPPROD")
    
    objFUNCOES.LimpaCampos Me
    
    objCADTIPAPPRODP.FILIAL = FILIAL
...
Private Sub AbilitaCampos()
    ...
    boolAtivoDesativo = objCADTIPAPPRODP.AtivoDesativo
...
Private Sub grdTIPAPONT_Click()
    With grdTIPAPONT
        If .Row = 0 Then Exit Sub
        If (.Rows - 1) > 0 Then objCADTIPAPPRODP.CODIGO = CInt(.Cell(flexcpText, .Row, conCOL_Mov_Codigo))
    End With
End Sub

Private Sub grdTIPAPONT_DblClick()
...
Private Sub grdTIPAPONT_KeyDown(KeyCode As Integer, Shift As Integer)
...
Private Sub grdTIPAPONT_RowColChange()
    With grdTIPAPONT
        If .Row = 0 Then Exit Sub
        If (.Rows - 1) > 0 Then objCADTIPAPPRODP.CODIGO = CInt(.Cell(flexcpText, .Row, conCOL_Mov_Codigo))
    End With
...
Private Sub Ordem()
    ...
    Do While Not BREC.EOF
       grdTIPAPONT.AddItem BREC!SGI_CODIGO & vbTab & _
                           BREC!SGI_DESCRI & vbTab & _
                           IIf(BREC!SGI_ATIVO = 1, "Sim", "Não")
       BREC.MoveNext
    Loop
...
Private Sub Operacao(strOperacao As String)
    ...
    frmCADTIPAPPROD.cCaminho = cCaminho
    frmCADTIPAPPROD.Linha = Linha
    frmCADTIPAPPROD.iCodigo = iCodigo
    frmCADTIPAPPROD.cTipOper = strOperacao
    frmCADTIPAPPROD.FILIAL = FILIAL
    frmCADTIPAPPROD.strAcesso = strAcesso
    frmCADTIPAPPROD.lngCODUSUARIO = lngIDUSUARIO
    frmCADTIPAPPROD.strUsuario = strUsuario
    frmCADTIPAPPROD.Show vbModal
