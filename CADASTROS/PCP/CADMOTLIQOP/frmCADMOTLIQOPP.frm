...
Begin VB.Form frmCADMOTLIQOPP 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton cmdVoltar 
         ...
         Height          =   615
         Left            =   120
         Picture         =   "frmCADMOTLIQOPP.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton cmdInclui 
         ...
         Height          =   615
         Left            =   960
         Picture         =   "frmCADMOTLIQOPP.frx":0532
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.CommandButton cmdAltera 
         ...
         Height          =   615
         Left            =   1800
         Picture         =   "frmCADMOTLIQOPP.frx":0A64
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      Begin VB.CommandButton cmdExclui 
         ...
         Height          =   615
         Left            =   2640
         Picture         =   "frmCADMOTLIQOPP.frx":0B66
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      Begin VB.CommandButton cmdCanFiltro 
         ...
         Height          =   615
         Left            =   8400
         Picture         =   "frmCADMOTLIQOPP.frx":0C68
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   120
         Width           =   855
      ...
      Begin VB.CommandButton cmdOrden 
         ...
         Height          =   615
         Left            =   9240
         Picture         =   "frmCADMOTLIQOPP.frx":119A
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   120
         Width           =   855
   ...
   End
End
Attribute VB_Name = "frmCADMOTLIQOPP"
...
Private Sub Form_Load()
    ...
    Set objCADTIPOSLIQP = CreateObject("CADMOTLIQOP.clsCADMOTLIQOP")
...
Private Sub Operacao(strOperacao As String)
    ...
    frmCADMOTLIQOP.cCaminho = cCaminho
    frmCADMOTLIQOP.Linha = Linha
    frmCADMOTLIQOP.iCodigo = iCodigo
    frmCADMOTLIQOP.cTipOper = strOperacao
    frmCADMOTLIQOP.FILIAL = FILIAL
    frmCADMOTLIQOP.strAcesso = strAcesso
    frmCADMOTLIQOP.lngCODUSUARIO = lngIDUSUARIO
    frmCADMOTLIQOP.strUsuario = strUsuario
    frmCADMOTLIQOP.Show vbModal
