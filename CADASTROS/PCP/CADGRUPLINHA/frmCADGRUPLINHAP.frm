...
Begin VB.Form frmCADGRUPLINHAP 
   ...
   Begin VB.Frame Frame2 
      ...
      Top             =   1440
      Width           =   10575
      Begin VSFlex8LCtl.VSFlexGrid grdCADGRPLIN 
         Height          =   5775
         Left            =   120
         TabIndex        =   13
         Top             =   240
   ...
   Begin VB.Frame cmdFECHA 
      ...
      Begin VB.CommandButton cmdOrden 
         ...
         Height          =   615
         Left            =   9600
         Picture         =   "frmCADGRUPLINHAP.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   120
         Width           =   855
      ...
      Begin VB.CommandButton cmdCanFiltro 
         ...
         Height          =   615
         Left            =   8760
         Picture         =   "frmCADGRUPLINHAP.frx":0102
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   120
         Width           =   855
      ...
      Begin VB.CommandButton cmdExclui 
         ...
         Height          =   615
         Left            =   3840
         Picture         =   "frmCADGRUPLINHAP.frx":0634
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      Begin VB.CommandButton cmdAltera 
         ...
         Height          =   615
         Left            =   2640
         Picture         =   "frmCADGRUPLINHAP.frx":0736
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      Begin VB.CommandButton cmdInclui 
         ...
         Height          =   615
         Left            =   1440
         Picture         =   "frmCADGRUPLINHAP.frx":0838
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      Begin VB.CommandButton cmdVoltar 
         ...
         Height          =   615
         Left            =   120
         Picture         =   "frmCADGRUPLINHAP.frx":0D6A
         Style           =   1  'Graphical
         TabIndex        =   1
   ...
   End
End
Attribute VB_Name = "frmCADGRUPLINHAP"
...
Dim objCADGRUPLINHAP    As Object
Dim iCodigo             As Long
...
Private Sub cmdExclui_Click()
  ...
  If objCADGRUPLINHAP.GRAVA("E", strNOMETABELA) = False Then Exit Sub
...
Private Sub Form_Load()
    ...
    Set objCADGRUPLINHAP = CreateObject("CADGRUPLINHA.clsCADGRUPLINHA")
    
    objCADGRUPLINHAP.FILIAL = FILIAL
    ...
    Me.Caption = Me.Caption & " - " & strEMPRESA & " - / " & strModulo

End Sub

Private Sub Destroy_Objeto()
    Set objFuncoes = Nothing
    Set objCADGRUPLINHAP = Nothing
End Sub
...
Private Sub AbilitaCampos()
    ...
    boolAtivoDesativo = objCADGRUPLINHAP.AtivoDesativo(strNOMETABELA)
...
Private Sub grdCADGRPLIN_Click()
    With grdCADGRPLIN
        If (.Rows - 1) > 0 And .Row > 0 Then objCADGRUPLINHAP.CODIGO = CLng(grdCADGRPLIN.Cell(flexcpText, .Row, conCOL_Mov_Codigo))
    End With
End Sub

Private Sub grdCADGRPLIN_DblClick()
...
Private Sub grdCADGRPLIN_RowColChange()
    With grdCADGRPLIN
        If (.Rows - 1) > 0 And .Row > 0 Then objCADGRUPLINHAP.CODIGO = CLng(grdCADGRPLIN.Cell(flexcpText, .Row, conCOL_Mov_Codigo))
    End With
End Sub
...
Private Sub Operacao(strOperacao As String)
    ...
    frmCADGRUPLINHA.cCaminho = cCaminho
    frmCADGRUPLINHA.Linha = Linha
    frmCADGRUPLINHA.iCodigo = iCodigo
    frmCADGRUPLINHA.cTipOper = strOperacao
    frmCADGRUPLINHA.FILIAL = FILIAL
    frmCADGRUPLINHA.strAcesso = strAcesso
    frmCADGRUPLINHA.strMODPAI = Me.Name
    frmCADGRUPLINHA.strUsuario = strUsuario
    frmCADGRUPLINHA.lngCodUsuario = lngCodUsuaro
    frmCADGRUPLINHA.strNOMEFILIAL = strEMPRESA
    frmCADGRUPLINHA.strNOMETABELA = strNOMETABELA
    frmCADGRUPLINHA.Show vbModal
...
Private Sub txtCampos_Validate(Cancel As Boolean)
    ...
    If Not BREC.EOF() Then
        ...
        Do While Not BREC.EOF()
            ...
            grdCADGRPLIN.AddItem strCampos
