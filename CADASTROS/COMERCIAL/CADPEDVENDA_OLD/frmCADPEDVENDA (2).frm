...
Const conCOL_SonProgEntr_DataPrevLito           As Integer = 3
Const conCOL_SonProgEntr_DataPrevProd           As Integer = 4
Const conCOL_SonProgEntr_Action2Do              As Integer = 5
Const conCOL_SonProgEntr_OBSOP                  As Integer = 6
Const conCOL_SonProgEntr_CodOP                  As Integer = 7
Const conCOL_SonProgEntr_StatusOP               As Integer = 8
Const conCOL_SonProgEntr_FechTpFr               As Integer = 9
Const conCOL_SonProgEntr_INDICE                 As Integer = 10
Const conCOL_SonProgEntr_INDICEBKP              As Integer = 11
Const conCOL_SonProgEntr_DataEntregaBKP         As Integer = 12
Const conCOL_SonProgEntr_IDINTERNO              As Integer = 13
Const conCOL_SonProgEntr_DescStatusOP           As Integer = 14
Const conCOL_SonProgEntr_GrpPlanMestre          As Integer = 15
Const conCOL_SonProgEntr_PegaPlanMestre         As Integer = 16
Const conCOL_SonProgEntr_QTDENOPALHET           As Integer = 17
Const conCOL_SonProgEntr_PALHET                 As Integer = 18
Const conCOL_SonProgEntr_Action2DoDtEntrega     As Integer = 19
Const conCOL_SonProgEntr_FormatString           As String = "=Cod|Quant.OP|Dt.Entrega|Dt.Ideal para Lito|Dt.Ideal para Prod.|Action2Do|OBSOP|Cod.OP|Status|FechTF|INDICE|INDICEBKP|DataEntregaBKP|IDINTERNO|Status.OP|GrPMestre|...|Qtde por Palhet|Qtde de Palhet|Action2DoDtEntrega"
Const conColumnsIn_SonProgEntr                  As Integer = 20
                ...
                If (.Cell(flexcpText, i, conCOL_SonProd_Action2Do) = dacEnumUpdateAction_Insert Or _
                   .Cell(flexcpText, i, conCOL_SonProd_Action2Do) = dacEnumUpdateAction_update) Then
                    If .Cell(flexcpText, i, conCOL_SonProd_StatusProd) = 1 Then
                        If cTipOper = "I" Or cTipOper = "A" Then objCADPEDVENDA.STATUS = "B"
    ...
    With grdProgEntrega
        If (.Rows - 1) > 0 Then
            ...
            For i = 1 To (.Rows - 1)
                ...
                arrENTREGAS(i, 5) = .Cell(flexcpText, i, conCOL_SonProgEntr_Action2Do)
                arrENTREGAS(i, 6) = Trim(Replace(Replace(.Cell(flexcpText, i, conCOL_SonProgEntr_OBSOP), "'", ""), ",", ""))
                
                arrENTREGAS(i, 7) = .Cell(flexcpText, i, conCOL_SonProgEntr_FechTpFr)
                ...
                If intPEGAFECH > -1 Then
                    arrENTREGAS(i, 7) = grdProduto.Cell(flexcpData, intPEGAFECH, conCOL_SonProd_FechTpFr)
                End If
                
                arrENTREGAS(i, 8) = Empty
                If Len(Trim(.Cell(flexcpText, i, conCOL_SonProgEntr_CodOP))) > 0 Then arrENTREGAS(i, 8) = .Cell(flexcpText, i, conCOL_SonProgEntr_CodOP)
                
                arrENTREGAS(i, 9) = .Cell(flexcpText, i, conCOL_SonProgEntr_INDICE)
                
                arrENTREGAS(i, 10) = Empty
                If Len(Trim(.Cell(flexcpText, i, conCOL_SonProgEntr_INDICEBKP))) > 0 Then arrENTREGAS(i, 10) = .Cell(flexcpText, i, conCOL_SonProgEntr_INDICEBKP)
            
                arrENTREGAS(i, 11) = Empty
                If Len(Trim(.Cell(flexcpText, i, conCOL_SonProgEntr_CodOP))) > 0 Then arrENTREGAS(i, 11) = Trim(Replace(.Cell(flexcpText, i, conCOL_SonProgEntr_CodOP), "/", ""))
            
                arrENTREGAS(i, 12) = Empty
                If Len(Trim(.Cell(flexcpText, i, conCOL_SonProgEntr_DataEntregaBKP))) > 0 Then arrENTREGAS(i, 12) = "'" & Format(CDate(.Cell(flexcpText, i, conCOL_SonProgEntr_DataEntregaBKP)), "MM/DD/YYYY") & "'"
                ...
                If intLINHAPROD > -1 Then
                    arrENTREGAS(i, 13) = grdProduto.Cell(flexcpText, intLINHAPROD, conCOL_SonProd_Codigo)
                    arrENTREGAS(i, 14) = grdProduto.Cell(flexcpText, intLINHAPROD, conCOL_SonProd_AltFilme)
                    arrENTREGAS(i, 15) = grdProduto.Cell(flexcpText, intLINHAPROD, conCOL_SonProd_FotNovo)
                    arrENTREGAS(i, 16) = grdProduto.Cell(flexcpText, intLINHAPROD, conCOL_SonProd_Repeticao)
                End If
                '' ===============================
                ...
                If .Cell(flexcpText, i, conCOL_SonProgEntr_Action2Do) = dacEnumUpdateAction_Insert Then
                    ...
                    arrENTREGAS(i, 17) = lngIDPROGENTREGA
                Else
                    arrENTREGAS(i, 17) = .Cell(flexcpText, i, conCOL_SonProgEntr_IDINTERNO)
                End If
                
                
                arrENTREGAS(i, 18) = .Cell(flexcpText, i, conCOL_SonProgEntr_StatusOP)
                ...
                arrENTREGAS(i, 20) = "Null"
            
                If Len(Trim(.Cell(flexcpText, i, conCOL_SonProgEntr_QTDENOPALHET))) Then arrENTREGAS(i, 19) = CLng(.Cell(flexcpText, i, conCOL_SonProgEntr_QTDENOPALHET))
                If Len(Trim(.Cell(flexcpText, i, conCOL_SonProgEntr_PALHET))) Then arrENTREGAS(i, 20) = CLng(.Cell(flexcpText, i, conCOL_SonProgEntr_PALHET))
                
                arrENTREGAS(i, 21) = .Cell(flexcpText, i, conCOL_SonProgEntr_Action2DoDtEntrega)
                ...
                If .Cell(flexcpText, i, conCOL_SonProgEntr_Action2Do) = dacEnumUpdateAction_update Then
                    If Len(Trim(.Cell(flexcpText, i, conCOL_SonProgEntr_DataEntrega))) > 0 And Len(Trim(.Cell(flexcpText, i, conCOL_SonProgEntr_DataEntregaBKP))) > 0 Then
                       If CDate(.Cell(flexcpText, i, conCOL_SonProgEntr_DataEntrega)) <> CDate(.Cell(flexcpText, i, conCOL_SonProgEntr_DataEntregaBKP)) Then
                            ...
                            arrENTREGAS(i, 23) = .Cell(flexcpText, i, conCOL_SonProgEntr_DataEntregaBKP)
                       End If
                    Else
                       arrENTREGAS(i, 22) = .Cell(flexcpText, i, conCOL_SonProgEntr_DataEntrega)
                       arrENTREGAS(i, 23) = .Cell(flexcpText, i, conCOL_SonProgEntr_DataEntrega)
                    End If
                End If
    ...
    Select Case Col
        Case conCOL_SonProgEntr_PegaPlanMestre
            ...
            With grdProgEntrega
                ...
                If grdProduto.RowSel = 0 Then
                    MsgBox "ATENÇÃO" & vbCrLf & _
                           "Seleciona uma Produto !!!", vbOKOnly + vbExclamation, "Aviso"
                           Exit Sub
                End If
...
Private Sub InitGridProg()
    ...
    With grdProgEntrega
       ...
       .ColWidth(conCOL_SonProgEntr_DataPrevLito) = 1300
       .ColWidth(conCOL_SonProgEntr_DataPrevProd) = 1500
...
On Error GoTo Err_IncRegGridProg
    ...
    With grdProduto
        ...
        grdProgEntrega.AddItem .Cell(flexcpText, .RowSel, conCOL_SonProd_IdProduto) & vbTab & _
                               ...
                               "" & vbTab & "" & vbTab & "" & vbTab & "" & dacEnumUpdateAction_Insert
    ...
    With grdProgEntrega
        For i = 1 To (.Rows - 1)
            If Len(Trim(.Cell(flexcpText, i, conCOL_SonProgEntr_DataEntrega))) > 0 Then
                ...
                dtDataLito = CDate(.Cell(flexcpText, i, conCOL_SonProgEntr_DataEntrega))
                lngQTDIAS = (dtDataEntr - Date)
                
                .Cell(flexcpText, i, conCOL_SonProgEntr_DataPrevLito) = Format((dtDataEntr - 4), "DD/MM/YYYY") '' Previsão de Litografia
                .Cell(flexcpText, i, conCOL_SonProgEntr_DataPrevProd) = Format((dtDataEntr - 2), "DD/MM/YYYY") '' Previsão de Produção
