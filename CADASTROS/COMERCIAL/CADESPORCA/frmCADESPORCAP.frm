...
Begin VB.Form frmCADESPORCAP 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton cmdOrden 
         ...
         Height          =   615
         Left            =   6960
         Picture         =   "frmCADESPORCAP.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   120
         Width           =   855
      ...
      Begin VB.CommandButton cmdCanFiltro 
         ...
         Height          =   615
         Left            =   6120
         Picture         =   "frmCADESPORCAP.frx":0102
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   120
         Width           =   855
      ...
      Begin VB.CommandButton cmdExclui 
         ...
         Height          =   615
         Left            =   2640
         Picture         =   "frmCADESPORCAP.frx":0634
         Style           =   1  'Graphical
         TabIndex        =   11
      ...
      Begin VB.CommandButton cmdAltera 
         ...
         Height          =   615
         Left            =   1800
         Picture         =   "frmCADESPORCAP.frx":0736
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      Begin VB.CommandButton cmdInclui 
         ...
         Height          =   615
         Left            =   960
         Picture         =   "frmCADESPORCAP.frx":0838
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      Begin VB.CommandButton cmdVoltar 
         ...
         Height          =   615
         Left            =   120
         Picture         =   "frmCADESPORCAP.frx":0D6A
         Style           =   1  'Graphical
         TabIndex        =   8
   ...
   Begin VB.Frame Frame3 
      ...
      Top             =   1440
      Width           =   7935
      Begin MSFlexGridLib.MSFlexGrid flxCADESPORCA 
         Height          =   3615
         Left            =   120
         TabIndex        =   1
         Top             =   240
   ...
   End
End
Attribute VB_Name = "frmCADESPORCAP"
...
Private Sub cmdExclui_Click()
  ...
  If objCADESPORCA.GRAVA("E") = False Then Exit Sub
...
Private Sub cmdOrden_Click()
    If flxCADESPORCA.Rows > 1 Then Ordem
End Sub
...
Private Sub flxCADESPORCA_Click()
    If flxCADESPORCA.Rows > 1 Then objCADESPORCA.ESPORCACOD = CInt(flxCADESPORCA.TextMatrix(flxCADESPORCA.RowSel, 1))
End Sub

Private Sub flxCADESPORCA_DblClick()
    If objFuncoes.ChecaAcesso2("C", strAcesso) = False Then Exit Sub
    If flxCADESPORCA.Rows > 1 Then Operacao "C"
End Sub

Private Sub flxCADESPORCA_RowColChange()
    If flxCADESPORCA.Rows > 1 Then objCADESPORCA.ESPORCACOD = CInt(flxCADESPORCA.TextMatrix(flxCADESPORCA.RowSel, 1))
End Sub
...
Private Sub Form_Load()
    ...
    objFuncoes.LimpaCampos frmCADESPORCAP
...
Private Sub AbilitaCampos()
    ...
    If objCADESPORCA.Pesq_CadEsporca = False Then
...
Private Sub ConfGrid()
    ...
    flxCADESPORCA.Rows = 1
    flxCADESPORCA.Cols = 3
    
    flxCADESPORCA.TextMatrix(0, 0) = ""
    flxCADESPORCA.TextMatrix(0, 1) = "Código"
    flxCADESPORCA.TextMatrix(0, 2) = "Descrição"
    
    flxCADESPORCA.ColWidth(0) = 0
    flxCADESPORCA.ColWidth(1) = 700
    flxCADESPORCA.ColWidth(2) = 5000
...
Private Sub PosGrid()
    ...
    If iCodigo > 0 Then
        ...
        For I = 1 To (flxCADESPORCA.Rows - 1)
             
            If flxCADESPORCA.TextMatrix(I, 1) = iCodigo Then
               flxCADESPORCA.Row = I
               flxCADESPORCA.Col = 1
...
Private Sub Operacao(strOperacao As String)
  ...
  If flxCADESPORCA.Rows > 1 Then iCodigo = CInt(flxCADESPORCA.TextMatrix(flxCADESPORCA.RowSel, 1))
  
  frmCADESPORCA.cCaminho = cCaminho
  frmCADESPORCA.Linha = Linha
  frmCADESPORCA.iCodigo = iCodigo
  frmCADESPORCA.cTipOper = strOperacao
  frmCADESPORCA.FILIAL = FILIAL
  frmCADESPORCA.strAcesso = strAcesso
  frmCADESPORCA.strMODPAI = Me.Name
...
Private Sub txtCampos_GotFocus()
    objFuncoes.SelecionaCampos txtCampos.Name, frmCADESPORCAP
End Sub
