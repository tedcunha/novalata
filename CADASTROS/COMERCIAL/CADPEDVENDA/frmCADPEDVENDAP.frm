...
Begin VB.Form frmCADPEDVENDAP 
   ...
   Begin VB.Frame Frame3 
      ...
      Begin TabDlg.SSTab stPEDIDOS 
         ...
         Tab(0).Control(0)=   "grdPEDIDOS"
         Tab(0).Control(1)=   "Label1(7)"
         Tab(0).Control(2)=   "lblRegsRelac(7)"
         ...
         Tab(5).Control(1)=   "grdLIBLITO"
         Tab(5).Control(2)=   "lblRegsRelac(0)"
         Tab(5).Control(3)=   "Label1(0)"
         Tab(5).ControlCount=   4
         TabCaption(6)   =   "Para Estoque"
         TabPicture(6)   =   "frmCADPEDVENDAP.frx":00A8
         Tab(6).ControlEnabled=   0   'False
         Tab(6).Control(0)=   "Command7"
         Tab(6).Control(1)=   "grdPARAEST"
         ...
         Tab(7).Control(2)=   "lblRegsRelac(3)"
         Tab(7).Control(3)=   "Label1(3)"
         Tab(7).ControlCount=   4
         TabCaption(8)   =   "Geral"
         TabPicture(8)   =   "frmCADPEDVENDAP.frx":00E0
         Tab(8).ControlEnabled=   0   'False
         Tab(8).Control(0)=   "grdGERAL"
         Tab(8).Control(1)=   "Label1(2)"
         Tab(8).Control(2)=   "lblRegsRelac(2)"
...
Const conCOL_SonPed_Seleciona                           As Integer = 0
Const conCOL_SonPed_Codigo                              As Integer = 1
Const conCOL_SonPed_Data                                As Integer = 2
Const conCOL_SonPed_Cliente                             As Integer = 3
Const conCOL_SonPed_Situacao                            As Integer = 4
Const conCOL_SonPed_Tipo                                As Integer = 5
Const conCOL_SonPed_Vendedor                            As Integer = 6
Const conCOL_SonPed_FormatString                        As String = "=  |Cód. Ped|Data|Cliente|S|Tipo Pedido|Vendedor"
Const conColumnsIn_SonPed                               As Integer = 7

Const conCOL_SonAgLib_Seleciona                         As Integer = 0
Const conCOL_SonAgLib_Codigo                            As Integer = 1
Const conCOL_SonAgLib_Data                              As Integer = 2
Const conCOL_SonAgLib_Cliente                           As Integer = 3
Const conCOL_SonAgLib_Situacao                          As Integer = 4
Const conCOL_SonAgLib_Tipo                              As Integer = 5
Const conCOL_SonAgLib_Vendedor                          As Integer = 6
Const conCOL_SonAgLib_FormatString                      As String = "=  |Cód. Ped|Data|Cliente|S|Tipo Pedido|Vendedor"
Const conColumnsIn_SonAgLib                             As Integer = 7

Const conCOL_SonFat_Seleciona                           As Integer = 0
Const conCOL_SonFat_Codigo                              As Integer = 1
Const conCOL_SonFat_Data                                As Integer = 2
Const conCOL_SonFat_Cliente                             As Integer = 3
Const conCOL_SonFat_Situacao                            As Integer = 4
Const conCOL_SonFat_Tipo                                As Integer = 5
Const conCOL_SonFat_Vendedor                            As Integer = 6
...
Const conCOL_SonRep_Seleciona                           As Integer = 0
Const conCOL_SonRep_Codigo                              As Integer = 1
Const conCOL_SonRep_Data                                As Integer = 2
Const conCOL_SonRep_Cliente                             As Integer = 3
Const conCOL_SonRep_Situacao                            As Integer = 4
Const conCOL_SonRep_Tipo                                As Integer = 5
Const conCOL_SonRep_Vendedor                            As Integer = 6
Const conCOL_SonRep_FormatString                        As String = "=  |Cód. Ped|Data|Cliente|S|Tipo Pedido|Vendedor"
Const conColumnsIn_SonRep                               As Integer = 7

Const conCOL_SonBloq_Seleciona                          As Integer = 0
Const conCOL_SonBloq_Codigo                             As Integer = 1
Const conCOL_SonBloq_Data                               As Integer = 2
Const conCOL_SonBloq_Cliente                            As Integer = 3
Const conCOL_SonBloq_Situacao                           As Integer = 4
Const conCOL_SonBloq_Tipo                               As Integer = 5
Const conCOL_SonBloq_Vendedor                           As Integer = 6
Const conCOL_SonBloq_FormatString                       As String = "=  |Cód. Ped|Data|Cliente|S|Tipo Pedido|Vendedor"
Const conColumnsIn_SonBloq                              As Integer = 7

Const conCOL_SonBloqLit_Seleciona                       As Integer = 0
Const conCOL_SonBloqLit_Codigo                          As Integer = 1
Const conCOL_SonBloqLit_Data                            As Integer = 2
Const conCOL_SonBloqLit_Cliente                         As Integer = 3
Const conCOL_SonBloqLit_Situacao                        As Integer = 4
Const conCOL_SonBloqLit_Tipo                            As Integer = 5
Const conCOL_SonBloqLit_Vendedor                        As Integer = 6
Const conCOL_SonBloqLit_FormatString                    As String = "=  |Cód. Ped|Data|Cliente|S|Tipo Pedido|Vendedor"
Const conColumnsIn_SonBloqLit                           As Integer = 7

Const conCOL_SonParaEst_Seleciona                       As Integer = 0
Const conCOL_SonParaEst_Codigo                          As Integer = 1
Const conCOL_SonParaEst_Data                            As Integer = 2
Const conCOL_SonParaEst_Cliente                         As Integer = 3
Const conCOL_SonParaEst_Situacao                        As Integer = 4
Const conCOL_SonParaEst_Tipo                            As Integer = 5
Const conCOL_SonParaEst_Vendedor                        As Integer = 6
Const conCOL_SonParaEst_FormatString                    As String = "=  |Cód. Ped|Data|Cliente|S|Tipo Pedido|Vendedor"
Const conColumnsIn_SonParaEst                           As Integer = 7

Const conCOL_SonBloqPDPC_Seleciona                      As Integer = 0
Const conCOL_SonBloqPDPC_Codigo                         As Integer = 1
Const conCOL_SonBloqPDPC_Data                           As Integer = 2
Const conCOL_SonBloqPDPC_Cliente                        As Integer = 3
Const conCOL_SonBloqPDPC_Situacao                       As Integer = 4
Const conCOL_SonBloqPDPC_Tipo                           As Integer = 5
Const conCOL_SonBloqPDPC_Vendedor                       As Integer = 6
Const conCOL_SonBloqPDPC_FormatString                   As String = "=  |Cód. Ped|Data|Cliente|S|Tipo Pedido|Vendedor"
Const conColumnsIn_SonBloqPDPC                          As Integer = 7

Const conCOL_SonGeral_Seleciona                         As Integer = 0
Const conCOL_SonGeral_Codigo                            As Integer = 1
Const conCOL_SonGeral_Data                              As Integer = 2
Const conCOL_SonGeral_Cliente                           As Integer = 3
Const conCOL_SonGeral_Situacao                          As Integer = 4
Const conCOL_SonGeral_Tipo                              As Integer = 5
Const conCOL_SonGeral_Vendedor                          As Integer = 6
Const conCOL_SonGeral_FormatString                      As String = "=  |Cód. Ped|Data|Cliente|S|Tipo Pedido|Vendedor"
Const conColumnsIn_SonGeral                             As Integer = 7
...
Err_cmdAltera_Click:
    ...
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : cmdAltera_Click()", Me.Name, "cmdAltera_Click()", strCAMARQERRO, strUSUARIO)
...
Err_cmdCanFiltro_Click:
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : cmdCanFiltro_Click()", Me.Name, "cmdCanFiltro_Click()", strCAMARQERRO, strUSUARIO)
...
Err_cmdDeslib_Click:
    ...
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : cmdDeslib_Click()", Me.Name, "cmdDeslib_Click()", strCAMARQERRO, strUSUARIO)
...
Err_cmdExclui_Click:
    ...
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : cmdExclui_Click()", Me.Name, "cmdExclui_Click()", strCAMARQERRO, strUSUARIO)
...
Err_cmdImpressao_Click:
    ...
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : cmdImpressao_Click()", Me.Name, "cmdImpressao_Click()", strCAMARQERRO, strUSUARIO)
...
Err_cmdInclui_Click:
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : cmdInclui_Click()", Me.Name, "cmdInclui_Click()", strCAMARQERRO, strUSUARIO)
...
Err_cmdLibera_Click:
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : cmdLibera_Click()", Me.Name, "cmdLibera_Click()", strCAMARQERRO, strUSUARIO)
...
Err_cmdLIBPDATAPCOTA_Click:
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : cmdLIBPDATAPCOTA_Click()", Me.Name, "cmdLIBPDATAPCOTA_Click()", strCAMARQERRO, strUSUARIO)
...
Err_Command1_Click:
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : Command1_Click()", Me.Name, "Command1_Click()", strCAMARQERRO, strUSUARIO)
...
Err_Command2_Click:
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : Command2_Click()", Me.Name, "Command2_Click()", strCAMARQERRO, strUSUARIO)
...
Err_Command3_Click:
    ...
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : Command3_Click()", Me.Name, "Command3_Click()", strCAMARQERRO, strUSUARIO)
...
Err_Command4_Click:
    ...
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : Command4_Click()", Me.Name, "Command4_Click()", strCAMARQERRO, strUSUARIO)
...
Err_Command5_Click:
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : Command5_Click()", Me.Name, "Command5_Click()", strCAMARQERRO, strUSUARIO)
...
Err_Command6_Click:
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : Command6_Click()", Me.Name, "Command6_Click()", strCAMARQERRO, strUSUARIO)
...
Err_Command7_Click:
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : Command7_Click()", Me.Name, "Command7_Click()", strCAMARQERRO, strUSUARIO)
...
Err_Command8_Click:
    ...
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : Command8_Click()", Me.Name, "Command8_Click()", strCAMARQERRO, strUSUARIO)
...
Err_Command9_Click:
    ...
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : Command9_Click()", Me.Name, "Command9_Click()", strCAMARQERRO, strUSUARIO)

End Sub

Private Sub Form_KeyDown(KeyCode As Integer, Shift As Integer)
   If KeyCode = vbKeyEscape Then cmdVoltar_Click
   If KeyCode = vbKeyF5 Then cmdOrden_Click
End Sub
...
Err_Form_Load:
    ...
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : Form_Load()", Me.Name, "Form_Load()", strCAMARQERRO, strUSUARIO, strUSUARIO)
...
Err_AbilitaCampos:
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : AbilitaCampos()", Me.Name, "AbilitaCampos()", strCAMARQERRO, strUSUARIO)
...
Err_Operacao:
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : Operacao()", Me.Name, "Operacao()", strCAMARQERRO, strUSUARIO)
...
Err_PreencheGridBloqueado:
    ...
    If BREC.State = 1 Then BREC.Close
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : PreencheGridBloqueado()", Me.Name, "PreencheGridBloqueado()", strCAMARQERRO, strUSUARIO)
...
Err_Verif_Cota:
    ...
    If BREC.State = 1 Then BREC.Close
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : Err_Verif_Cota()", Me.Name, "Err_Verif_Cota()", strCAMARQERRO, strUSUARIO)
...
On Error GoTo Err_VerifNF
    ...
    strEMPTABELA = ""
    If intFILIALPED = 1 Then strEMPTABELA = "_STEEL"
    ...
    sSql = sSql & "       * " & vbCrLf
    sSql = sSql & "  From " & vbCrLf
    sSql = sSql & "       SGI_CADORDFATH" & strEMPTABELA & vbCrLf
    sSql = sSql & " Where " & vbCrLf
    sSql = sSql & "       SGI_FILIAL = " & FILIAL & vbCrLf
...
Err_VerifNF:
    ...
    If BREC.State = 1 Then BREC.Close
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : VerifNF()", Me.Name, "VerifNF()", strCAMARQERRO, strUSUARIO)
...
Private Sub ConfGridFaturado()
    ...
    With grdPEDFATURADO
       ...
       .Cell(flexcpData, 0, conCOL_SonFat_Seleciona) = ""
       .ColDataType(conCOL_SonFat_Seleciona) = flexDTBoolean
       ...
       .ColWidth(conCOL_SonFat_Seleciona) = 200
...
Err_PreencheGridFaturado:
    ...
    If BREC.State = 1 Then BREC.Close
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : PreencheGridFaturado()", Me.Name, "PreencheGridFaturado()", strCAMARQERRO, strUSUARIO)
...
Private Sub grdBLOQALT_BeforeEdit(ByVal Row As Long, ByVal Col As Long, Cancel As Boolean)

    Select Case Col
    Case conCOL_SonBloq_Seleciona
    Case Else
        Cancel = True
    End Select
...
Private Sub grdGERAL_BeforeEdit(ByVal Row As Long, ByVal Col As Long, Cancel As Boolean)

    Select Case Col
    Case conCOL_SonGeral_Seleciona
    Case Else
        Cancel = True
    End Select
...
Err_grdGERAL_Click:
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : grdGERAL_Click()", Me.Name, "grdGERAL_Click()", strCAMARQERRO, strUSUARIO)
...
Err_grdGERAL_DblClick:
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : grdGERAL_DblClick()", Me.Name, "grdGERAL_DblClick()", strCAMARQERRO, strUSUARIO)
...
Err_grdGERAL_KeyDown:
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : grdGERAL_KeyDown()", Me.Name, "grdGERAL_KeyDown()", strCAMARQERRO, strUSUARIO)
...
Err_grdGERAL_RowColChange:
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : grdGERAL_RowColChange()", Me.Name, "grdGERAL_RowColChange()", strCAMARQERRO, strUSUARIO)

End Sub

Private Sub grdGRIDBLOQUADOS_BeforeEdit(ByVal Row As Long, ByVal Col As Long, Cancel As Boolean)

    Select Case Col
    Case conCOL_SonAgLib_Seleciona
    Case Else
        Cancel = True
    End Select
...
Err_grdGRIDBLOQUADOS_Click:
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : grdGRIDBLOQUADOS_Click()", Me.Name, "grdGRIDBLOQUADOS_Click()", strCAMARQERRO, strUSUARIO)
...
Err_grdGRIDBLOQUADOS_DblClick:
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : grdGRIDBLOQUADOS_DblClick()", Me.Name, "grdGRIDBLOQUADOS_DblClick()", strCAMARQERRO, strUSUARIO)
...
Err_grdGRIDBLOQUADOS_KeyDown:
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : grdGRIDBLOQUADOS_KeyDown()", Me.Name, "grdGRIDBLOQUADOS_KeyDown()", strCAMARQERRO, strUSUARIO)
...
Err_grdGRIDBLOQUADOS_RowColChange:
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : grdGRIDBLOQUADOS_RowColChange()", Me.Name, "grdGRIDBLOQUADOS_RowColChange()", strCAMARQERRO, strUSUARIO)

End Sub

Private Sub grdLIBLITO_BeforeEdit(ByVal Row As Long, ByVal Col As Long, Cancel As Boolean)

    Select Case Col
    Case conCOL_SonBloqLit_Seleciona
    Case Else
        Cancel = True
    End Select
...
Private Sub grdLIBPDATAPCOTA_BeforeEdit(ByVal Row As Long, ByVal Col As Long, Cancel As Boolean)

    Select Case Col
    Case conCOL_SonBloqPDPC_Seleciona
    Case Else
        Cancel = True
    End Select
...
Private Sub grdPARAEST_BeforeEdit(ByVal Row As Long, ByVal Col As Long, Cancel As Boolean)

    Select Case Col
    Case conCOL_SonParaEst_Seleciona
    Case Else
        Cancel = True
    End Select
...
Private Sub grdPEDFATURADO_BeforeEdit(ByVal Row As Long, ByVal Col As Long, Cancel As Boolean)

    Select Case Col
    Case conCOL_SonFat_Seleciona
    Case Else
        Cancel = True
    End Select
...
Private Sub grdPEDIDOS_BeforeEdit(ByVal Row As Long, ByVal Col As Long, Cancel As Boolean)

    Select Case Col
    Case conCOL_SonPed_Seleciona
    Case Else
        Cancel = True
    End Select
...
Err_grdPEDIDOS_Click:
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : grdPEDIDOS_Click()", Me.Name, "grdPEDIDOS_Click()", strCAMARQERRO, strUSUARIO)
...
Err_grdPEDIDOS_DblClick:
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : grdPEDIDOS_DblClick()", Me.Name, "grdPEDIDOS_DblClick()", strCAMARQERRO, strUSUARIO)
...
Err_grdPEDIDOS_KeyDown:
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : grdPEDIDOS_KeyDown()", Me.Name, "grdPEDIDOS_KeyDown()", strCAMARQERRO, strUSUARIO)
...
Err_grdPEDIDOS_RowColChange:
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : grdPEDIDOS_RowColChange()", Me.Name, "grdPEDIDOS_RowColChange)", strCAMARQERRO, strUSUARIO)

End Sub

Private Sub grdReprovados_BeforeEdit(ByVal Row As Long, ByVal Col As Long, Cancel As Boolean)

    Select Case Col
    Case conCOL_SonRep_Seleciona
    Case Else
        Cancel = True
    End Select
...
Err_grdReprovados_Click:
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : grdReprovados_Click()", Me.Name, "grdReprovados_Click()", strCAMARQERRO, strUSUARIO)
...
Err_grdReprovados_RowColChange:
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : grdReprovados_RowColChange()", Me.Name, "grdReprovados_RowColChange()", strCAMARQERRO, strUSUARIO)
...
Err_optLiberados_Click:
    ...
    If BREC.State = 1 Then BREC.Close
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : optLiberados_Click()", Me.Name, "optLiberados_Click()", strCAMARQERRO, strUSUARIO)
...
On Error GoTo Err_Atualiza_Grid
    ...
    With msfGRID
        If stPEDIDOS.Tab = 0 Then
            ...
            lngCOL0 = conCOL_SonPed_Seleciona
            lngCOL1 = conCOL_SonPed_Codigo
            lngCOL2 = conCOL_SonPed_Data
            lngCOL3 = conCOL_SonPed_Cliente
            lngCOL4 = conCOL_SonPed_Situacao
            lngCOL5 = conCOL_SonPed_Tipo
            lngCOL5 = conCOL_SonPed_Vendedor
            
            lngLINHA = .FindRow(Format(strCODIGO, "#/####"), , lngCOL1)
            If lngLINHA > -1 Then
        ...
        ElseIf stPEDIDOS.Tab = 1 Then
            ...
            lngCOL0 = conCOL_SonAgLib_Seleciona
            lngCOL1 = conCOL_SonAgLib_Codigo
            lngCOL2 = conCOL_SonAgLib_Data
            lngCOL3 = conCOL_SonAgLib_Cliente
            lngCOL4 = conCOL_SonAgLib_Situacao
            lngCOL5 = conCOL_SonAgLib_Tipo
            lngCOL6 = conCOL_SonAgLib_Vendedor
        ...
        ElseIf stPEDIDOS.Tab = 2 Then
            ...
            lngCOL0 = conCOL_SonRep_Seleciona
            lngCOL1 = conCOL_SonRep_Codigo
            lngCOL2 = conCOL_SonRep_Data
            lngCOL3 = conCOL_SonRep_Cliente
            lngCOL4 = conCOL_SonRep_Situacao
            lngCOL5 = conCOL_SonRep_Tipo
            lngCOL6 = conCOL_SonRep_Vendedor
        ...
        ElseIf stPEDIDOS.Tab = 3 Then
            ...
            lngCOL0 = conCOL_SonFat_Seleciona
            lngCOL1 = conCOL_SonFat_Codigo
            lngCOL2 = conCOL_SonFat_Data
            lngCOL3 = conCOL_SonFat_Cliente
            lngCOL4 = conCOL_SonFat_Situacao
            lngCOL5 = conCOL_SonFat_Tipo
            lngCOL6 = conCOL_SonFat_Vendedor
        ...
        ElseIf stPEDIDOS.Tab = 4 Then
            ...
            lngCOL0 = conCOL_SonBloq_Seleciona
            lngCOL1 = conCOL_SonBloq_Codigo
            lngCOL2 = conCOL_SonBloq_Data
            lngCOL3 = conCOL_SonBloq_Cliente
            lngCOL4 = conCOL_SonBloq_Situacao
            lngCOL5 = conCOL_SonBloq_Tipo
            lngCOL6 = conCOL_SonBloq_Vendedor
        ...
        ElseIf stPEDIDOS.Tab = 5 Then
            ...
            lngCOL0 = conCOL_SonBloqLit_Seleciona
            lngCOL1 = conCOL_SonBloqLit_Codigo
            lngCOL2 = conCOL_SonBloqLit_Data
            lngCOL3 = conCOL_SonBloqLit_Cliente
            lngCOL4 = conCOL_SonBloqLit_Situacao
            lngCOL5 = conCOL_SonBloqLit_Tipo
            lngCOL6 = conCOL_SonBloqLit_Vendedor
        ...
        ElseIf stPEDIDOS.Tab = 7 Then
            ...
            lngCOL0 = conCOL_SonBloqPDPC_Seleciona
            lngCOL1 = conCOL_SonBloqPDPC_Codigo
            lngCOL2 = conCOL_SonBloqPDPC_Data
            lngCOL3 = conCOL_SonBloqPDPC_Cliente
            lngCOL4 = conCOL_SonBloqPDPC_Situacao
            lngCOL5 = conCOL_SonBloqPDPC_Tipo
            lngCOL6 = conCOL_SonBloqPDPC_Vendedor
        ...
        ElseIf stPEDIDOS.Tab = 8 Then
            ...
            lngCOL0 = conCOL_SonGeral_Seleciona
            lngCOL1 = conCOL_SonGeral_Codigo
            lngCOL2 = conCOL_SonGeral_Data
            lngCOL3 = conCOL_SonGeral_Cliente
            lngCOL4 = conCOL_SonGeral_Situacao
            lngCOL5 = conCOL_SonGeral_Tipo
            lngCOL6 = conCOL_SonGeral_Vendedor
        ...
        If bolAchou = False Then
            Do While Not BRECATU.EOF()
                .AddItem 0 & vbTab & _
                         Format(BRECATU!SGI_CODIGO, "#/####") & vbTab & _
        ...
        ElseIf bolAchou = True Then
            If Not BRECATU.EOF() Then
                .Cell(flexcpText, lngLINHA, lngCOL1) = Format(BRECATU!SGI_CODIGO, "#/####")
                .Cell(flexcpText, lngLINHA, lngCOL2) = Format(BRECATU!SGI_DATAPED, "DD/MM/YYYY")
                .Cell(flexcpText, lngLINHA, lngCOL3) = BRECATU!SGI_RAZAOSOC
                .Cell(flexcpText, lngLINHA, lngCOL4) = IIf(BRECATU!SGI_STATUS = "4", "D", BRECATU!SGI_STATUS)
                .Cell(flexcpText, lngLINHA, lngCOL5) = BRECATU!SGI_DESCRICAO
                .Cell(flexcpText, lngLINHA, lngCOL6) = BRECATU!SGI_NOMVEND
            End If
        End If
...
Err_Atualiza_Grid:
    ...
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : Atualiza_Grid()", Me.Name, "Atualiza_Grid()", strCAMARQERRO, strUSUARIO)
...
On Error GoTo Err_Ordem
    ...
    If boolPermOPSel = True Then
        ...
        sSql = sSql & "      ,SGI_ORDEMPROD" & strEMPTABELA & "     ORDP" & vbCrLf
    End If
    '' ===============================
    ...
    If Len(Trim(txtCODOP.Text)) > 0 Then
        ...
        sSql = sSql & "   And ORP.SGI_CODIGO = " & Trim(Replace(Replace(txtCODOP.Text, ",", ""), ".", "")) & vbCrLf
    ...
    If Len(Trim(txtCODPED.Text)) > 0 Then
        sSql = sSql & "   And PED.SGI_CODIGO = " & Trim(Replace(Replace(txtCODPED.Text, ",", ""), ".", "")) & vbCrLf
        boolTEMCAMPOPREENCH = True
    End If
    If Len(Trim(txtCODVENDEDOR.Text)) > 0 Then
        sSql = sSql & "   And PED.SGI_CODVEND = " & Trim(Replace(Replace(txtCODVENDEDOR.Text, ",", ""), ".", "")) & vbCrLf
        boolTEMCAMPOPREENCH = True
    End If
    If Len(Trim(txtCODCLIE.Text)) > 0 Then
        sSql = sSql & "   And PED.SGI_CODCLI = " & Trim(Replace(Replace(txtCODCLIE.Text, ",", ""), ".", "")) & vbCrLf
        boolTEMCAMPOPREENCH = True
    End If
    ...
    '' Permite manipular as OP's
    If boolPermOPSel = True Then
        sSql = sSql & "   And ORDP.SGI_FILIAL   = PED.SGI_FILIAL" & vbCrLf
        sSql = sSql & "   And ORDP.SGI_CODPED   = PED.SGI_CODIGO" & vbCrLf
        sSql = sSql & "   And OPMI.SGI_FILIAL   = ORDP.SGI_FILIAL" & vbCrLf
        sSql = sSql & "   And OPMI.SGI_CODOP    = ORDP.SGI_CODIGO" & vbCrLf
...
Err_Ordem:
    ...
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : Ordem()", Me.Name, "Ordem()", strCAMARQERRO, strUSUARIO)
...
On Error GoTo Err_Imp
    ...
    Dim strCODPEDIDOS   As String
    Dim i               As Long
    
    Dim lngCOL0         As Long
    Dim lngCOL1         As Long
    Dim grdGER          As VSFlexGrid
    
    If stPEDIDOS.Tab = 0 Then
        lngCOL0 = conCOL_SonPed_Seleciona
        lngCOL1 = conCOL_SonPed_Codigo
        Set grdGER = grdPEDIDOS
    ElseIf stPEDIDOS.Tab = 1 Then
        lngCOL0 = conCOL_SonAgLib_Seleciona
        lngCOL1 = conCOL_SonAgLib_Codigo
        Set grdGER = grdGRIDBLOQUADOS
    ElseIf stPEDIDOS.Tab = 2 Then
        lngCOL0 = conCOL_SonRep_Seleciona
        lngCOL1 = conCOL_SonRep_Codigo
        Set grdGER = grdReprovados
    ElseIf stPEDIDOS.Tab = 3 Then
        lngCOL0 = conCOL_SonFat_Seleciona
        lngCOL1 = conCOL_SonFat_Codigo
        Set grdGER = grdPEDFATURADO
    ElseIf stPEDIDOS.Tab = 4 Then
        lngCOL0 = conCOL_SonBloq_Seleciona
        lngCOL1 = conCOL_SonBloq_Codigo
        Set grdGER = grdBLOQALT
    ElseIf stPEDIDOS.Tab = 5 Then
        lngCOL0 = conCOL_SonBloqLit_Seleciona
        lngCOL1 = conCOL_SonBloqLit_Codigo
        Set grdGER = grdLIBLITO
    ElseIf stPEDIDOS.Tab = 6 Then
        lngCOL0 = conCOL_SonParaEst_Seleciona
        lngCOL1 = conCOL_SonParaEst_Codigo
        Set grdGER = grdPARAEST
    ElseIf stPEDIDOS.Tab = 7 Then
        lngCOL0 = conCOL_SonBloqPDPC_Seleciona
        lngCOL1 = conCOL_SonBloqPDPC_Codigo
        Set grdGER = grdLIBPDATAPCOTA
    ElseIf stPEDIDOS.Tab = 8 Then
        lngCOL0 = conCOL_SonGeral_Seleciona
        lngCOL1 = conCOL_SonGeral_Codigo
        Set grdGER = grdGERAL
    ...
    With grdGER
        For i = 1 To (.Rows - 1)
            If .Cell(flexcpChecked, i, lngCOL0) = 1 Then
                strCODPEDIDOS = strCODPEDIDOS & Trim(Replace(.Cell(flexcpText, i, lngCOL1), "/", "")) & ","
            End If
        Next i
        If Len(Trim(strCODPEDIDOS)) = 0 Then
            MsgBox "ATENÇÂO" & vbCrLf & _
                   "Selecione Um ou Mais Pedidos para Impressão !!!", vbOKOnly + vbExclamation, "Aviso"
            Exit Sub
        End If
        strCODPEDIDOS = Mid(strCODPEDIDOS, 1, (Len(strCODPEDIDOS) - 1))
    End With
    ...
    sSql = sSql & "      ,SGI_CADPEDVENDI.SGI_DESCPROD" & vbCrLf
    ...
    sSql = sSql & "      ,SGI_CADPEDVENDI.SGI_FechSoldaAgrafado" & vbCrLf
    sSql = sSql & "      ,SGI_CADPEDVENDI.SGI_VernCorpo" & vbCrLf
    sSql = sSql & "      ,SGI_CADPEDVENDI.SGI_VernTampa" & vbCrLf
    sSql = sSql & "      ,SGI_CADPEDVENDI.SGI_VernFundo" & vbCrLf
    sSql = sSql & "      ,SGI_CADPEDVENDI.SGI_VernArgola" & vbCrLf
    ...
    sSql = sSql & "      ,SGI_CADVENDEDOR.SGI_FILIAL" & vbCrLf
    sSql = sSql & "      ,SGI_CADVENDEDOR.SGI_DESCRICAO" & vbCrLf
    ...
    sSql = sSql & "   And SGI_CADPEDVENDI.SGI_CODIGO   In(" & Trim(strCODPEDIDOS) & ")" & vbCrLf
    ...
    sSql = sSql & "   And SGI_CADPEDVENDH.SGI_FILIAL     = SGI_CADTRANSP.SGI_FILIAL" & vbCrLf
    sSql = sSql & "   And SGI_CADPEDVENDH.SGI_CODTRANSP  = SGI_CADTRANSP.SGI_CODIGO" & vbCrLf
    
    sSql = sSql & "   And SGI_CADPEDVENDH.SGI_FILIAL     = SGI_CADCONDPGTO.SGI_FILIAL" & vbCrLf
    sSql = sSql & "   And SGI_CADPEDVENDH.SGI_CODCONDPGT = SGI_CADCONDPGTO.SGI_CODIGO" & vbCrLf
   ...
   If stPEDIDOS.Tab = 0 Then
        strNOMREL = "RELPVNOVA1A.RPT"
   Else
        strNOMREL = "RELPVNOVA21A.RPT"
   End If
...
Err_Imp:
    ...
    If BREC.State = 1 Then BREC.Close
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : ImpPed()", Me.Name, "ImpPed()", strCAMARQERRO, strUSUARIO)
...
Err_PegaCodVendedor:
    ...
    If BREC.State = 1 Then BREC.Close
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : PegaCodVendedor()", Me.Name, "PegaCodVendedor()", strCAMARQERRO, strUSUARIO)
...
On Error GoTo Err_AtivaDesativaBotoes
    ...
    cmdExclui.Visible = PermiteExcPed
...
Err_AtivaDesativaBotoes:
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : AtivaDesativaBotoes()", Me.Name, "AtivaDesativaBotoes()", strCAMARQERRO, strUSUARIO)
...
Err_PegaOPS:
    If BREC10.State = 1 Then BREC.Close
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : PegaOPS()", Me.Name, "PegaOPS()", strCAMARQERRO, strUSUARIO)
...
On Error GoTo Err_ImpSteel
    ...
    sSql = sSql & "      ,SGI_CADPEDVENDI_STEEL.SGI_DESCPROD" & vbCrLf
    ...
    sSql = sSql & "      ,SGI_CADPEDVENDI_STEEL.SGI_FechSoldaAgrafado" & vbCrLf
    sSql = sSql & "      ,SGI_CADPEDVENDI_STEEL.SGI_VernCorpo" & vbCrLf
    sSql = sSql & "      ,SGI_CADPEDVENDI_STEEL.SGI_VernTampa" & vbCrLf
    sSql = sSql & "      ,SGI_CADPEDVENDI_STEEL.SGI_VernFundo" & vbCrLf
    sSql = sSql & "      ,SGI_CADPEDVENDI_STEEL.SGI_VernArgola" & vbCrLf
    ...
    sSql = sSql & " Where " & vbCrLf
    sSql = sSql & "      SGI_CADPEDVENDI_STEEL.SGI_FILIAL    = " & FILIAL & vbCrLf
    
    ''sSql = sSql & "   And SGI_CADPEDVENDI_STEEL.SGI_CODIGO    = " & objCADPEDVENDA.CODPEDIDO & vbCrLf
    sSql = sSql & "   And SGI_CADPEDVENDI_STEEL.SGI_CODIGO   In(" & Trim(strCODPEDIDOS) & ")" & vbCrLf
   ...
   If stPEDIDOS.Tab = 0 Then
        strNOMREL = "RELPVSTEEL1A.RPT"
        ''strNOMREL = "RELPVSTEEL.RPT"
   Else
        strNOMREL = "RELPVSTEEL21A.RPT"
...
Err_ImpSteel:
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : ImpPedSteel()", Me.Name, "ImpPedSteel()", strCAMARQERRO, strUSUARIO)
...
Private Sub ConfGridBloqAlt()
    ...
    With grdBLOQALT
       ...
       .Cell(flexcpData, 0, conCOL_SonBloq_Seleciona) = ""
       .ColDataType(conCOL_SonBloq_Seleciona) = flexDTBoolean
       ...
       .ColWidth(conCOL_SonBloq_Seleciona) = 200
...
Private Sub ConfGridBloqAltLit()
    ...
    With grdLIBLITO
       ...
       .Cell(flexcpData, 0, conCOL_SonBloqLit_Seleciona) = ""
       .ColDataType(conCOL_SonBloqLit_Seleciona) = flexDTBoolean
       ...
       .ColWidth(conCOL_SonBloqLit_Seleciona) = 200
...
Private Sub ConfGridParaEstoque()
    ...
    With grdPARAEST
       ...
       .Cell(flexcpData, 0, conCOL_SonParaEst_Seleciona) = ""
       .ColDataType(conCOL_SonParaEst_Seleciona) = flexDTBoolean
       ...
       .ColWidth(conCOL_SonParaEst_Seleciona) = 200
...
Private Sub ConfGridBloqPDataPCota()
    ...
    With grdLIBPDATAPCOTA
       ...
       .Cell(flexcpData, 0, conCOL_SonBloqPDPC_Seleciona) = ""
       .ColDataType(conCOL_SonBloqPDPC_Seleciona) = flexDTBoolean
       ...
       .ColWidth(conCOL_SonBloqPDPC_Seleciona) = 200
...
Private Sub ConfGridAgLib()
    ...
    With grdGRIDBLOQUADOS
       ...
       .Cell(flexcpData, 0, conCOL_SonAgLib_Seleciona) = ""
       .ColDataType(conCOL_SonAgLib_Seleciona) = flexDTBoolean
       ...
       .ColWidth(conCOL_SonAgLib_Seleciona) = 200
...
Private Sub ConfGridPedidos()
    ...
    With grdPEDIDOS
       ...
       .Cell(flexcpData, 0, conCOL_SonPed_Seleciona) = ""
       .ColDataType(conCOL_SonPed_Seleciona) = flexDTBoolean
       ...
       .ColWidth(conCOL_SonPed_Seleciona) = 200
...
Private Sub ConfGridReprovados()
    ...
    With grdReprovados
       ...
       .Cell(flexcpData, 0, conCOL_SonRep_Seleciona) = ""
       .ColDataType(conCOL_SonRep_Seleciona) = flexDTBoolean
       ...
       .ColWidth(conCOL_SonRep_Seleciona) = 200
...
Err_txtCODCLIE_Validate:
    ...
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : txtCODCLIE_Validate()", Me.Name, "txtCODCLIE_Validate()", strCAMARQERRO, strUSUARIO)
...
Private Sub txtCODPED_Validate(Cancel As Boolean)
    ...
    txtCODPED.Text = Trim(Replace(Replace(txtCODPED.Text, ",", ""), ".", ""))
...
On Error GoTo Err_txtCODVENDEDOR_Validate
    ...
    txtCODVENDEDOR.Text = Trim(Replace(Replace(txtCODVENDEDOR.Text, ",", ""), ".", ""))
...
Err_txtCODVENDEDOR_Validate:
    ...
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : txtCODVENDEDOR_Validate()", Me.Name, "txtCODVENDEDOR_Validate()", strCAMARQERRO, strUSUARIO)
...
Private Sub ConfGridGeral()
    ...
    With grdGERAL
       ...
       .Cell(flexcpData, 0, conCOL_SonGeral_Seleciona) = ""
       .ColDataType(conCOL_SonGeral_Seleciona) = flexDTBoolean
       ...
       .ColWidth(conCOL_SonGeral_Seleciona) = 200
...
Private Function ConsisteCampos() As Boolean
    ...
    If Len(Trim(strDATAI)) < 8 Then
        MsgBox "ATENÇÂO" & vbCrLf & _
               "A data inicial não é válida !!!"
        ConsisteCampos = False
        Exit Function
    End If
    If Len(Trim(strDATAF)) < 8 Then
        MsgBox "ATENÇÂO" & vbCrLf & _
               "A data final não é válida !!!"
        ConsisteCampos = False
        Exit Function
    End If
...
Err_PegaDescTabelas:
    ...
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : PegaDescTabelas()" & vbCrLf & "Campo Nome : " & txtGeral.Name & vbCrLf & "Função Pai : " & strFUNCAOPAI & vbCrLf & "Usuário : " & strUSUARIO, Me.Name, "PegaDescTabelas()", strCAMARQERRO, strUSUARIO)
...
Err_PegaDescTabelas:
    ...
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : PegaDescTabelas()", Me.Name, "PegaDescTabelas()", strCAMARQERRO, strUSUARIO)
...
Public Sub Imprime_Ped_Novo()


On Error GoTo Err_Imprime_Ped_Novo
    ...
    BREC10.Open sSql, adoBanco_Dados, adOpenDynamic
    If Not BREC10.EOF() Then boolTEMDADOS = True
    BREC10.Close
...
Err_Imprime_Ped_Novo:
    Call objFuncoes.Sub_DescErro(Str(Err.Number), Err.Description, cTipOper, "Função : Imprime_Ped_Novo()", Me.Name, "Imprime_Ped_Novo()", strCAMARQERRO, strUSUARIO)
...
Private Function PermiteExcPed() As Boolean
    ...
    sSql = sSql & "       SGI_FILIAL      = " & FILIAL & vbCrLf
    sSql = sSql & "   And SGI_CODIGO      = " & lngCodUsuaro & vbCrLf
    sSql = sSql & "   And SGI_PERMEXCPED  = 1"

    BREC.Open sSql, adoBanco_Dados, adOpenDynamic
    If Not BREC.EOF() Then PermiteExcPed = True
    BREC.Close
