...
Begin VB.Form frmCADORDEMCORESP 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton cmdImpressao 
         ...
         Height          =   615
         Left            =   3480
         Picture         =   "frmCADORDEMCORESP.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.CommandButton cmdVoltar 
         ...
         Height          =   615
         Left            =   120
         Picture         =   "frmCADORDEMCORESP.frx":0102
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton cmdInclui 
         ...
         Height          =   615
         Left            =   960
         Picture         =   "frmCADORDEMCORESP.frx":0634
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.CommandButton cmdAltera 
         ...
         Height          =   615
         Left            =   1800
         Picture         =   "frmCADORDEMCORESP.frx":0B66
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      Begin VB.CommandButton cmdExclui 
         ...
         Height          =   615
         Left            =   2640
         Picture         =   "frmCADORDEMCORESP.frx":0C68
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      Begin VB.CommandButton cmdCanFiltro 
         ...
         Height          =   615
         Left            =   10800
         Picture         =   "frmCADORDEMCORESP.frx":0D6A
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      Begin VB.CommandButton cmdOrden 
         ...
         Height          =   615
         Left            =   11520
         Picture         =   "frmCADORDEMCORESP.frx":129C
         Style           =   1  'Graphical
         TabIndex        =   1
   ...
   End
End
Attribute VB_Name = "frmCADORDEMCORESP"
...
Dim objCADORDEMCORESP   As Object
Dim iCodigo             As Long
Dim strModulo           As String

Const conCOL_Mov_Codigo                          As Integer = 0
Const conCOL_Mov_Defalt                          As Integer = 1
Const conCOL_Mov_FormatString                    As String = "=Código|Padrão"
...
Private Sub cmdExclui_Click()
  ...
  If objCADORDEMCORESP.GRAVA("E") = False Then Exit Sub
...
Private Sub Form_Load()
   ...
   Set objCADORDEMCORESP = CreateObject("CADORDEMCORES.clsCADORDEMCORES")
    
   objCADORDEMCORESP.FILIAL = FILIAL
...
Private Sub AbilitaCampos()
    ...
    boolAtivoDesativo = objCADORDEMCORESP.AtivoDesativo
...
Private Sub ConfGrid()
    ...
    With grdCORES
       ...
       .Cell(flexcpData, 0, conCOL_Mov_Defalt) = ""
       .ColDataType(conCOL_Mov_Defalt) = flexDTString
       
       .ColWidth(conCOL_Mov_Codigo) = 1000
       .ColWidth(conCOL_Mov_Defalt) = 1000
...
Private Sub Operacao(strOperacao As String)
    ...
    frmCADORDEMCORES.cCaminho = cCaminho
    frmCADORDEMCORES.Linha = Linha
    frmCADORDEMCORES.iCodigo = iCodigo
    frmCADORDEMCORES.cTipOper = strOperacao
    frmCADORDEMCORES.FILIAL = FILIAL
    frmCADORDEMCORES.strAcesso = strAcesso
    frmCADORDEMCORES.strMODPAI = Me.Name
    frmCADORDEMCORES.strUsuario = strUsuario
    frmCADORDEMCORES.lngCodVendedor = lngCodVendedor
    frmCADORDEMCORES.lngCodUsuario = lngCodUsuaro
    frmCADORDEMCORES.intFILIALPED = intFILIALPED
    frmCADORDEMCORES.Show vbModal
    
    Call AbilitaCampos

End Sub

Private Sub grdCORES_Click()
    With grdCORES
        If (.Rows - 1) > 0 Or .Row > 0 Then objCADORDEMCORESP.CODIGO = CInt(.Cell(flexcpText, .Row, conCOL_Mov_Codigo))
    End With
End Sub

Private Sub grdCORES_DblClick()
...
Private Sub grdCORES_KeyDown(KeyCode As Integer, Shift As Integer)
...
Private Sub grdCORES_RowColChange()
    With grdCORES
        If (.Rows - 1) > 0 Or .Row > 0 Then objCADORDEMCORESP.CODIGO = CInt(.Cell(flexcpText, .Row, conCOL_Mov_Codigo))
    End With
End Sub
...
Private Sub Ordem()
  ...
  sSql = sSql & "        SGI_CADORDEMCORES  COR" & vbCrLf
  sSql = sSql & " Where " & vbCrLf
  sSql = sSql & "       COR.SGI_FILIAL     = " & FILIAL & vbCrLf
  sSql = sSql & " Order by COR.SGI_CODIGO "
  ...
  If Not BREC.EOF() Then
    With grdCORES
        Do While Not BREC.EOF()
            ...
            If BREC!SGI_DEFALT = 1 Then strDEFALT = "SIM"
            If BREC!SGI_DEFALT = 0 Then strDEFALT = "NÃO"
...
Private Sub txtCampos_Validate(Cancel As Boolean)
    ...
    If cboFiltro.ListIndex = 0 Then sSql = sSql & "   And COR.SGI_CODIGO       = " & Trim(txtCampos.Text) & vbCrLf
