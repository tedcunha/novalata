...
Begin VB.Form frmCADESPPRODP 
   ...
   Begin VB.Frame Frame3 
      ...
      Top             =   1440
      Width           =   7935
      Begin MSFlexGridLib.MSFlexGrid flxESPPROD 
         Height          =   3135
         Left            =   120
         TabIndex        =   13
         Top             =   240
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton cmdVoltar 
         ...
         Height          =   615
         Left            =   120
         Picture         =   "frmCADESPPRODP.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton cmdInclui 
         ...
         Height          =   615
         Left            =   960
         Picture         =   "frmCADESPPRODP.frx":0532
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.CommandButton cmdAltera 
         ...
         Height          =   615
         Left            =   1800
         Picture         =   "frmCADESPPRODP.frx":0A64
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      Begin VB.CommandButton cmdExclui 
         ...
         Height          =   615
         Left            =   2640
         Picture         =   "frmCADESPPRODP.frx":0B66
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      Begin VB.CommandButton cmdCanFiltro 
         ...
         Height          =   615
         Left            =   6120
         Picture         =   "frmCADESPPRODP.frx":0C68
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   120
         Width           =   855
      ...
      Begin VB.CommandButton cmdOrden 
         ...
         Height          =   615
         Left            =   6960
         Picture         =   "frmCADESPPRODP.frx":119A
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   120
         Width           =   855
   ...
   End
End
Attribute VB_Name = "frmCADESPPRODP"
...
Private Sub cmdExclui_Click()
  ...
  If objCADESPPROD.GRAVA("E") = False Then Exit Sub
...
Private Sub Operacao(Operacao As String)
  ...
  If flxESPPROD.Rows > 1 Then
     iCodigo = CInt(flxESPPROD.TextMatrix(flxESPPROD.RowSel, 1))
  End If
  
  frmCADESPPROD.cCaminho = cCaminho
  frmCADESPPROD.Linha = Linha
  frmCADESPPROD.iCodigo = iCodigo
  frmCADESPPROD.cTipOper = Operacao
  frmCADESPPROD.FILIAL = FILIAL
...
Private Sub cmdOrden_Click()
    If flxESPPROD.Rows > 1 Then Ordem
End Sub
...
Private Sub flxESPPROD_Click()
    If flxESPPROD.Rows > 1 Then objCADESPPROD.ESPPRODCOD = CInt(flxESPPROD.TextMatrix(flxESPPROD.RowSel, 1))
End Sub

Private Sub flxESPPROD_DblClick()
    If objFuncoes.ChecaAcesso2("C", strAcesso) = False Then Exit Sub
    If flxESPPROD.Rows > 1 Then Operacao "C"
End Sub

Private Sub flxESPPROD_KeyDown(KeyCode As Integer, Shift As Integer)
...
Private Sub flxESPPROD_RowColChange()
    If flxESPPROD.Rows > 1 Then objCADESPPROD.ESPPRODCOD = CInt(flxESPPROD.TextMatrix(flxESPPROD.RowSel, 1))
End Sub
...
Private Sub Form_Load()
    ...
    objFuncoes.LimpaCampos frmCADESPPRODP
...
Private Sub AbilitaCampos()
    ...
    If objCADESPPROD.Pesq_CadEspProd = False Then
...
Private Sub ConfGrid()
    ...
    flxESPPROD.TextMatrix(0, 1) = "Código"
    flxESPPROD.TextMatrix(0, 2) = "Descrição"
    
    flxESPPROD.ColWidth(0) = 0
    flxESPPROD.ColWidth(1) = 700
    flxESPPROD.ColWidth(2) = 5000
...
Private Sub PreencheGrid()
    ...
    sSql = "Select * from SGI_CADESPPROD " & vbCrLf
    ...
    Do While Not BREC.EOF
       flxESPPROD.AddItem "" & vbTab & BREC!SGI_CODIGO & vbTab & BREC!SGI_DESCRICAO
       BREC.MoveNext
    Loop
...
Private Sub PosGrid()
    ...
    If iCodigo > 0 Then
        ...
        For I = 1 To (flxESPPROD.Rows - 1)
             
            If flxESPPROD.TextMatrix(I, 1) = iCodigo Then
               flxESPPROD.Row = I
               flxESPPROD.Col = 1
...
Private Sub txtCampos_GotFocus()
    objFuncoes.SelecionaCampos txtCampos.Name, frmCADESPPRODP
End Sub
...
Private Function Verifica_Integracao() As Boolean
     ...
     sSql = sSql & "   And SGI_CODESPECIE = " & objCADESPPROD.ESPPRODCOD
     
     BREC.Open sSql, adoBanco_Dados, adOpenDynamic
     
     If Not BREC.EOF Then
        MsgBox "Há produtos com está espécie cadastrada impossivel Excluir !!!", vbInformation + vbOKOnly, "Aviso"
        BREC.Close
        Exit Function
     End If
     ...
     If Not BREC.EOF Then
        MsgBox "Há Sub grupos de produtos com está espécie cadastrada impossivel Excluir !!!", vbInformation + vbOKOnly, "Aviso"
        BREC.Close
        Exit Function
     End If
