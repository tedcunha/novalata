...
Private Sub cmdExclui_Click()
  ...
  If Consistencia = False Then
     MsgBox "Existem requisições com este motivo relacionado !!!", vbOKOnly + vbExclamation, "Aviso"
     Exit Sub
  End If
...
Private Sub ConfGrid()
    ...
    flxCADMOTIVOS.TextMatrix(0, 1) = "Código"
    flxCADMOTIVOS.TextMatrix(0, 2) = "Descrição"
