...
Begin VB.Form frmCADPROD 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin TabDlg.SSTab stProd 
         ...
         Tab(5).Control(0)=   "grdUnidConv"
         Tab(5).Control(1)=   "cmdIncUnidConv"
         Tab(5).Control(2)=   "cmdexcUnidConv"
         ...
         Begin VB.Frame Frame19 
            ...
            Begin VB.CommandButton Command10 
               ...
               Width           =   300
            End
            Begin MSComctlLib.TreeView treListaMat 
               Height          =   5175
               Left            =   120
               TabIndex        =   267
               Top             =   240
         ...
         Begin TabDlg.SSTab stFichaTec 
            ...
            Tab(1).ControlEnabled=   0   'False
            Tab(1).Control(0)=   "label11(4)"
            Tab(1).Control(1)=   "label11(0)"
            Tab(1).Control(2)=   "label11(1)"
            Tab(1).Control(3)=   "label11(2)"
            Tab(1).Control(4)=   "label11(8)"
            Tab(1).Control(5)=   "label11(9)"
            Tab(1).Control(6)=   "label11(18)"
            Tab(1).Control(7)=   "Frame38(1)"
            Tab(1).Control(8)=   "Frame38(0)"
            Tab(1).Control(9)=   "Frame38(3)"
            Tab(1).Control(10)=   "txtQtdePassada"
            Tab(1).Control(11)=   "Frame7"
            Tab(1).Control(12)=   "Frame8"
            Tab(1).Control(13)=   "Frame10"
